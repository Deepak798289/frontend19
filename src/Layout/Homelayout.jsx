                     ...
                     {!isLoggedIn && (
                        <li className=" absolute bottom-1 w-[90%]">
                         <div className="w-full flex items-center justify-center" >
                            <button className="btn btn-primary px-2 py-1 font-semibold rounded-md w-full ">
                             <Link to="/login">Login</Link>
                            </button>
                            <button className="btn btn-secondary px-2 py-1 font-semibold rounded-md w-full ">
